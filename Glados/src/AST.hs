...
getTypeFunctionCall "factorial" _ = T_Function [typeInteger] T_UInt
getTypeFunctionCall "ADD_ASSIGN" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "add=" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "SUB_ASSIGN" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "sub=" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "MUL_ASSIGN" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "mul=" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "DIV_ASSIGN" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "div=" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "MOD_ASSIGN" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "mod=" _ = T_Function [T_String, typeNumber] T_Bool
getTypeFunctionCall "POW_ASSIGN" _ = T_Function [T_String, typeNumber] T_Bool
